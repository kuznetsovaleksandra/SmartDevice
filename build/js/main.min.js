...
/* harmony import */ var _modules_chapter_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/chapter.js */ "./js/modules/chapter.js");
/* harmony import */ var _modules_change_text_on_mobile_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/change-text-on-mobile.js */ "./js/modules/change-text-on-mobile.js");
/* harmony import */ var _modules_about_close_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/about-close.js */ "./js/modules/about-close.js");
/* harmony import */ var _modules_scroll_to_form_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/scroll-to-form.js */ "./js/modules/scroll-to-form.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_chapter_js__WEBPACK_IMPORTED_MODULE_2__["chaptersStart"])();
  Object(_modules_change_text_on_mobile_js__WEBPACK_IMPORTED_MODULE_3__["changeTextOnMobile"])();
  Object(_modules_about_close_js__WEBPACK_IMPORTED_MODULE_4__["aboutClose"])();
  Object(_modules_forms_js__WEBPACK_IMPORTED_MODULE_6__["forms"])();
  Object(_modules_scroll_to_form_js__WEBPACK_IMPORTED_MODULE_5__["scrollToForm"])();
...
/***/ "./js/modules/about-close.js":
/*!***********************************!*\
  !*** ./js/modules/about-close.js ***!
  \***********************************/
/*! exports provided: aboutClose */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "aboutClose", function() { return aboutClose; });
var aboutBtn = document.querySelector('.about__btn');
var hiddenBlocks = document.querySelectorAll('.about__hidden-block');
var hiddenBlocksOnMobile = document.querySelectorAll('.about__hidden-block--on-mobile');
var breakpoint = window.matchMedia('(max-width:767px)');
var breakpointChecker = function breakpointChecker() {
  if (breakpoint.matches) {
    hiddenBlocksOnMobile.forEach(function (block) {
...
breakpoint.addListener(breakpointChecker);
breakpointChecker();
var hideBloks = function hideBloks(block) {
  block.classList.add('about__hidden-block--close');
};
var showBloks = function showBloks(block) {
  block.classList.remove('about__hidden-block--close');
};
var aboutClose = function aboutClose() {
  if (aboutBtn) {
    if (hiddenBlocks) {
      ...
      var openBtnText = aboutBtn.textContent;
      var closeBtnText = aboutBtn.dataset.openText;
...
/***/ "./js/modules/change-text-on-mobile.js":
/*!*********************************************!*\
  !*** ./js/modules/change-text-on-mobile.js ***!
  \*********************************************/
/*! exports provided: changeTextOnMobile */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "changeTextOnMobile", function() { return changeTextOnMobile; });
var changeableElements = document.querySelectorAll('[data-mobile-text]');
var breakpoint = window.matchMedia('(max-width:767px)');
changeableElements.forEach(function (element) {
  element.dataset.desktopText = element.textContent;
});
var changeTextOnMobile = function changeTextOnMobile() {
  var breakpointChecker = function breakpointChecker() {
    if (breakpoint.matches) {
      changeableElements.forEach(function (element) {
...
/***/ "./js/modules/chapter.js":
/*!*******************************!*\
  !*** ./js/modules/chapter.js ***!
  \*******************************/
/*! exports provided: chaptersStart */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "chaptersStart", function() { return chaptersStart; });
var chapters = document.querySelectorAll('.chapter');
var chaptersClose = function chaptersClose(tab) {
  var tabTitle = tab.querySelector('.chapter__title');
  var tabContent = tab.querySelector('.chapter__content');
  tabTitle.classList.add('chapter__title--closed');
  tabContent.classList.remove('chapter__content--active');
};
var chaptersOpen = function chaptersOpen(tab) {
  var tabTitle = tab.querySelector('.chapter__title');
  var tabContent = tab.querySelector('.chapter__content');
  tabTitle.classList.remove('chapter__title--closed');
  tabContent.classList.add('chapter__content--active');
};
var chaptersStart = function chaptersStart() {
  chapters.forEach(function (tab) {
    chaptersClose(tab);
    var tabTitle = tab.querySelector('.chapter__title');
    tabTitle.addEventListener('click', function () {
      if (tabTitle.classList.contains('chapter__title--closed')) {
        chapters.forEach(function (openTab) {
...
var getTelMask = function getTelMask(tel) {
...
/* harmony import */ var _validation_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./validation.js */ "./js/modules/validation.js");

var feedbackForm = document.querySelector('.feedback__form');
var modalForm = document.querySelector('.modal__form');
var forms = function forms() {
  if (feedbackForm) {
    Object(_validation_js__WEBPACK_IMPORTED_MODULE_0__["formValidateAndSend"])(feedbackForm);
  }
  if (modalForm) {
    Object(_validation_js__WEBPACK_IMPORTED_MODULE_0__["formValidateAndSend"])(modalForm);
  }
};

/***/ }),

/***/ "./js/modules/modals/focus-on-first-modal.js":
/*!***************************************************!*\
  !*** ./js/modules/modals/focus-on-first-modal.js ***!
  \***************************************************/
/*! exports provided: focusOnFirstModal */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "focusOnFirstModal", function() { return focusOnFirstModal; });
var focusOnFirstModal = function focusOnFirstModal(modal) {
...
/* harmony import */ var _focus_on_first_modal_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./focus-on-first-modal.js */ "./js/modules/modals/focus-on-first-modal.js");
...
var Modals = /*#__PURE__*/function () {
  ...
  _createClass(Modals, [{
    ...
    value: function open() {
      ...
      Object(_focus_on_first_modal_js__WEBPACK_IMPORTED_MODULE_2__["focusOnFirstModal"])(modal);
    }
  }, {
    key: "close",
...
var btn = document.querySelector('.prime__btn');
      ...
      var breakpointChecker = function breakpointChecker() {
        if (breakpointMobile.matches) {
          btn.addEventListener('click', function () {
            Object(animated_scroll_to__WEBPACK_IMPORTED_MODULE_0__["default"])(form, {
              verticalOffset: -50,
              speed: 500
            });
          });
...
/*!**********************************!*\
  !*** ./js/modules/validation.js ***!
  \**********************************/
/*! exports provided: formValidateAndSend */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "formValidateAndSend", function() { return formValidateAndSend; });
...
/* harmony import */ var _utils_server_api_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/server-api.js */ "./js/utils/server-api.js");
/* harmony import */ var _form_mask_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./form-mask.js */ "./js/modules/form-mask.js");



var formValidateAndSend = function formValidateAndSend(form) {
  var tel = form.querySelector('input[type=tel]');
  var submitBtn = form.querySelector('button[type=submit]');
  var submitBtnText = submitBtn.textContent;
  var formName = form.classList.value.split('_')[0];
  Object(_form_mask_js__WEBPACK_IMPORTED_MODULE_2__["getTelMask"])(tel);
  ...
  var validateTel = function validateTel(value) {
  ...
  form.addEventListener('submit', function (evt) {
    ...
    if (isValid) {
      ...
      Object(_utils_server_api_js__WEBPACK_IMPORTED_MODULE_1__["sendData"])(function () {
        unblockSubmitButton();
        form.reset();
      }, function () {
        unblockSubmitButton();
...
var sendData = function sendData(onSuccess, onFail, body) {
  fetch('https://echo.htmlacademy.ru/', {
    ...
    return response.ok ? onSuccess() : onFail('Данные не отправлены, попробуйте еще раз');
  }).catch(function () {
